<?php
/**
 * Onplay Wallet settings
 *
 * @author Subrata Mal
 */

if ( ! class_exists( 'Onplay_Wallet_Extensions_Settings' ) ) :
	/**
	 * Wallet extention page class.
	 */
	class Onplay_Wallet_Extensions_Settings {
		/**
		 * Settings API
		 *
		 * @var object
		...
		public function __construct( $settings_api ) {
			...
			add_action( 'onplay_wallet_form_bottom__wallet_settings_extensions_general', array( $this, 'display_extensions' ) );
		}
		...
		public function admin_menu() {
			add_submenu_page( 'onplay-wallet', __( 'Extensions', 'onplay-wallet' ), __( 'Extensions', 'onplay-wallet' ), get_wallet_user_capability(), 'onplay-wallet-extensions', array( $this, 'plugin_page' ) );
		}
		...
		public function admin_enqueue_scripts() {
			...
			if ( in_array( $screen_id, array( "{$onplay_wallet_screen_id}_page_onplay-wallet-extensions" ), true ) ) {
				wp_enqueue_style( 'dashicons' );
				wp_enqueue_style( 'wp-color-picker' );
				wp_enqueue_style( 'onplay_wallet_admin_styles' );
				wp_add_inline_style( 'onplay_wallet_admin_styles', 'tr.licence_key_nonce{ display:none; }' );
				wp_enqueue_media();
		...
		public function get_settings_sections() {
			$sections = array(
				array(
					...
					'title' => __( 'Extensions', 'onplay-wallet' ),
					'icon'  => 'dashicons-admin-plugins',
				),
			);
			return apply_filters( 'onplay_wallet_extensions_settings_sections', $sections );
		}
		...
		public function get_settings_fields() {
			...
			return apply_filters( 'onplay_wallet_extensions_settings_filds', $settings_fields );
		}
					...
					<div class="addons-banner-block-items">
						<div class="addons-banner-block-item">
							<div class="addons-banner-block-item-icon">
								<img class="addons-img" src="<?php echo esc_url( onplay_wallet()->plugin_url() . '/assets/images/wallet-withdrawal.png' ); ?>">
							</div>
						...
						<div class="addons-banner-block-item">
							<div class="addons-banner-block-item-icon">
								<img class="addons-img" src="<?php echo esc_url( onplay_wallet()->plugin_url() . '/assets/images/wallet-importer.png' ); ?>">
							</div>
							<div class="addons-banner-block-item-content">
						...
						<div class="addons-banner-block-item">
							<div class="addons-banner-block-item-icon">
								<img class="addons-img" src="<?php echo esc_url( onplay_wallet()->plugin_url() . '/assets/images/wallet-coupons.png' ); ?>">
							</div>
							<div class="addons-banner-block-item-content">
						...
						<div class="addons-column-block">
							...
							<div class="addons-column-block-item">
								<div class="addons-column-block-item-icon">
									<img class="addons-img" src="<?php echo esc_url( onplay_wallet()->plugin_url() . '/assets/images/wallet-affiliatewp.png' ); ?>">
								</div>
...
new Onplay_Wallet_Extensions_Settings( onplay_wallet()->settings_api );
