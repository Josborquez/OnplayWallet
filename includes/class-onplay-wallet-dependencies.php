...
if ( ! class_exists( 'Onplay_Wallet_Dependencies' ) ) {
	 ...
	 */
	class Onplay_Wallet_Dependencies {
		/**
		 ...
		 * @return Boolean
		 */
		public static function onplay_wallet_active_check() {
			if ( ! self::$active_plugins ) {
				self::init();
			}
			return in_array( 'onplay-wallet/onplay-wallet.php', self::$active_plugins, true ) || array_key_exists( 'onplay-wallet/onplay-wallet.php', self::$active_plugins );
		}
		 ...
		 * @return Boolean
		 */
		public static function is_onplay_wallet_active() {
			return self::onplay_wallet_active_check();
		}
