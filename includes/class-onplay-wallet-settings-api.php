...
if ( ! class_exists( 'Onplay_Wallet_Settings_API' ) ) :
	/**
	 * Wallet setting API class.
	 */
	class Onplay_Wallet_Settings_API {
		...
		public function callback_file( $args ) {
			...
			$value = esc_attr( $this->get_option( $args['id'], $args['section'], $args['std'] ) );
			$size  = isset( $args['size'] ) && ! is_null( $args['size'] ) ? $args['size'] : 'regular';
			$label = isset( $args['options']['button_label'] ) ? $args['options']['button_label'] : __( 'Choose File', 'onplay-wallet' );
			?>
		...
		public function callback_attachment( $args ) {
			...
			$label                = isset( $args['options']['button_label'] ) ? $args['options']['button_label'] : __( 'Choose File', 'onplay-wallet' );
			$uploader_title       = isset( $args['options']['uploader_title'] ) ? $args['options']['uploader_title'] : __( 'Select', 'onplay-wallet' );
			$uploader_button_text = isset( $args['options']['uploader_button_text'] ) ? $args['options']['uploader_button_text'] : __( 'Select', 'onplay-wallet' );
		...
		public function get_option( $option, $section, $default = '' ) {
			...
			return apply_filters( "onplay_wallet_get_option_{$section}_{$option}", $option_value );
		}
				...
				<?php foreach ( $this->settings_sections as $form ) { ?>
					<div id="<?php echo esc_attr( $form['id'] ); ?>" class="group" style="display: none;">
						<form method="post" action="options.php">
							<?php
							do_action( 'onplay_wallet_form_top_' . $form['id'], $form );
							settings_fields( $form['id'] );
							do_settings_sections( $form['id'] );
							do_action( 'onplay_wallet_form_bottom_' . $form['id'], $form );
