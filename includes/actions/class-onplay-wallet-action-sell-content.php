 ...
 */
class Onplay_Wallet_Action_Sell_Content extends WooWalletAction {
	/**
	 * Class constructor.
	 */
	public function __construct() {
		$this->id           = 'sell_content';
		$this->action_title = __( 'Sell Content', 'onplay-wallet' );
		$this->description  = __( 'Sell your content using wallet balance. Use shortcode <code>[tw-sell-content]</code> to sell part of a content.', 'onplay-wallet' );
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			'enabled'                     => array(
				...
				'type'    => 'checkbox',
				'label'   => __( 'Enable sell Content action', 'onplay-wallet' ),
				'default' => 'no',
			),
			'post_types'                  => array(
				'title'       => __( 'Which post type(s) content do you want to sell?', 'onplay-wallet' ),
				'type'        => 'multiselect',
				'class'       => 'wc-enhanced-select',
				'css'         => 'min-width: 350px;',
				'desc_tip'    => true,
				'description' => __( 'This option lets you to choose post types which you want to sell.', 'onplay-wallet' ),
				'options'     => self::get_post_types_options(),
				'default'     => array(),
			),
			'default_amount'              => array(
				'title'       => __( 'Default Amount', 'onplay-wallet' ),
				'type'        => 'price',
				'description' => __( 'Enter amount which will be from user wallet when purchase paid content.', 'onplay-wallet' ),
				'default'     => '10',
				'desc_tip'    => true,
			),
			'profit_share'                => array(
				'title'             => __( 'Profit Share', 'onplay-wallet' ),
				'description'       => __( 'Option to pay a percentage of each sale with the content author.', 'onplay-wallet' ),
				'type'              => 'number',
				'desc_tip'          => true,
				'default'           => 0,
			...
			'expiration'                  => array(
				'title'             => __( 'Expiration', 'onplay-wallet' ),
				'description'       => __( 'Option to automatically expire purchases after certain number of Hour(s). Use zero to disable..', 'onplay-wallet' ),
				'type'              => 'number',
				'desc_tip'          => true,
				'default'           => 0,
				'custom_attributes' => array(
			...
			'purchase_description'        => array(
				'title'       => __( 'Purchase Description', 'onplay-wallet' ),
				'type'        => 'text',
				'description' => __( 'Purchase transaction description that will display as transaction note. Available Tags<code>#title#</code> <code>#link_with_title#</code>', 'onplay-wallet' ),
				'default'     => __( 'Purchase of #title#', 'onplay-wallet' ),
				'desc_tip'    => false,
			),
			'sell_description'            => array(
				'title'       => __( 'Selling Description', 'onplay-wallet' ),
				'type'        => 'text',
				'description' => __( 'Selling transaction description that will display as transaction note. Available Tags<code>#title#</code> <code>#link_with_title#</code>', 'onplay-wallet' ),
				'default'     => __( 'Sale of #title#', 'onplay-wallet' ),
				'desc_tip'    => false,
			),
			'button_lable'                => array(
				'title'       => __( 'Button Label', 'onplay-wallet' ),
				'type'        => 'text',
				'description' => __( 'Enter pay button lable. Available Tags<code>#price#</code>', 'onplay-wallet' ),
				'default'     => __( 'Pay #price#', 'onplay-wallet' ),
				'desc_tip'    => true,
			),
			'button_css_class'            => array(
				'title'       => __( 'Button CSS Classes', 'onplay-wallet' ),
				'type'        => 'text',
				'description' => __( 'Enter custom button CSS Classes', 'onplay-wallet' ),
				'default'     => __( 'button button-primary', 'onplay-wallet' ),
				'desc_tip'    => true,
			),
			'purchase_template_title'     => array(
				'title'       => __( 'Purchase Template', 'onplay-wallet' ),
				'type'        => 'title',
				'description' => __( 'The content will be replaced with this template when viewed by a user that has not paid for the content but can afford to pay.', 'onplay-wallet' ),
			),
			'purchase_template'           => array(
                ...
                #buy_button#',
				'description' => __( 'Available Tags: <code>#buy_button#</code> <code>#price#</code> <code>#balance#</code>', 'onplay-wallet' ),
			),
			'insufficient_funds_title'    => array(
				'title'       => __( 'Insufficient Funds Template', 'onplay-wallet' ),
				'type'        => 'title',
				'description' => __( 'The content will be replaced with this template when viewed by a user that has not paid for the content and can not afford to pay.', 'onplay-wallet' ),
			),
			'insufficient_funds_template' => array(
				...
				'description' => __( 'Available Tags: <code>#price#</code> <code>#balance#</code>', 'onplay-wallet' ),
			),
			'visitors_template_title'     => array(
				'title'       => __( 'Visitors Template', 'onplay-wallet' ),
				'type'        => 'title',
				'description' => __( 'The content will be replaced with this template when viewed by someone who is not logged in on your website.', 'onplay-wallet' ),
			),
			'visitors_template'           => array(
				...
				'description' => __( 'Available Tags: <code>#price#</code>', 'onplay-wallet' ),
			),
		);
	}
	/**
	...
	public function add_meta_box( $post_type ) {
		...
		if ( in_array( $post_type, $post_types, true ) ) {
			add_meta_box(
				'tw_sell_content',
				__( 'Sell this content', 'onplay-wallet' ),
	...
	public function render_tw_sell_meta_box_content( $post ) {
		...
		<div class="hcf_box">
			...
			<p class="meta-options hcf_field">
				<label for="tw_sell_content"><?php echo esc_html_e( 'Enable/Disable', 'onplay-wallet' ); ?></label>
				<input type="checkbox" name="tw_sell_content" id="tw_sell_content" value="1" <?php checked( $tw_sell_content, '1' ); ?> />
			</p>
			<p class="meta-options hcf_field">
				<label for="tw_sell_content_amount"><?php echo esc_html_e( 'Price', 'onplay-wallet' ); ?></label>
	...
	public function validate_content_for_sale( $content ) {
		...
		if ( ! $this->has_paid( $tw_sell_content_amount ) ) {
			if ( onplay_wallet()->wallet->get_wallet_balance( get_current_user_id(), 'edit' ) >= $tw_sell_content_amount ) {
	...
	private function render_settings_template( $template_option_name, $amount = 0, $id = 'tw-sell-content' ) {
		...
		$content = str_replace( '#balance#', onplay_wallet()->wallet->get_wallet_balance(), $content );
	...
	public function handle_purchase_content() {
		...
		if ( isset( $_POST['tw_buy_content_nonce'] ) ) { // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
			...
			if ( wp_verify_nonce( wp_unslash( $_POST['tw_buy_content_nonce'] ), 'tw_buy_content_nonce_' . $post->ID . '_' . $user_id . '_' . $amount ) ) { // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized
				...
				$transaction_id         = onplay_wallet()->wallet->debit( $user_id, $tw_sell_content_amount, $purchase_description );
				$expiration             = intval( $this->settings['expiration'] );
				if ( $transaction_id ) {
					if ( $profit_share ) {
						$profit = $tw_sell_content_amount * $profit_share / 100;
						onplay_wallet()->wallet->credit( $post_author, $profit, $sell_description );
					}
					if ( $expiration ) {
				...
				wc_add_notice( __( 'Cheatin&#8217; huh?', 'onplay-wallet' ), 'error' );
			}
		}
	}
	/**
	...
	public function tw_sell_content_shortcode_callback( $atts, $content = null ) {
		...
		if ( ! $this->has_paid( $amount, $atts['id'] ) ) {
			if ( onplay_wallet()->wallet->get_wallet_balance( get_current_user_id(), 'edit' ) >= $amount ) {
